 ...
 * @copyright 2020-2026 Joomlashack. All rights reserved
    ...
    public static function map($id, $params, $center = null, $markerData = [])
    {
        ...
        $options = json_encode([
            ...
            'mapProperties'  => [
                ...
                'gestureHandling'          => $params->get('gestureHandling', ''),
                'fullscreenControl'        => (bool)$params->get('fullscreen'),
                ...
                'streetViewControl'        => (bool)$params->get('streetViewControl'),
                'styles'                   => $params->get('mapstyle', []),
                'zoom'                     => (int)$params->get('zoom'),
                'zoomControl'              => (bool)$params->get('zoomControl'),
            ],
